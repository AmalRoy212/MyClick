        ...
        <MDBContainer className=" h-100">
          <MDBRow className="justify-content-center align-items-center h-100" style={{ width: '100%' }}>
            <MDBCol lg="9" xl="7" style={{ width: '100%' }}>
              <MDBCard style={{ width: '100%', marginTop: '7rem' }}>
                <div className="rounded-top text-white d-flex flex-row" style={{ backgroundColor: '#000', height: '200px' }}>
                  ...
                  <div className="ms-3" style={{ marginTop: '130px' }}>
                    ...
                    <MDBCardText>{user ? user.email : null}</MDBCardText>
                  </div>
                </div>
                <div className="p-4 text-black" style={{ backgroundColor: '#f8f9fa' }}>
                  <LinkContainer to={'/edit/profile'}>
                    <Nav.Link>
                      <Button className='m-2' style={{ marginLeft: '5rem' }}>Edit Profile</Button>
                    </Nav.Link>
                  </LinkContainer>
                ...
                <MDBCardBody className="text-black p-4">
                  <div className="mb-5">
                    ...
                    <div className="p-4" style={{ backgroundColor: '#f8f9fa' }}>
                      <MDBCardText className="font-italic mb-1">{user ? user.email : null}</MDBCardText>
